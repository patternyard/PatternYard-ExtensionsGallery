 ...
 */
(function (Scratch) {
    console.warn('Hey, I am rewriting this extension, check extensions.patternyard.dev for an update every now and then, this version is very bugged -Miyo');
    ...
    if (!vm.exports.JSGenerator) {
      throw new Error('"Scope Variables (Compiled)" extension cannot run without older compiler exports.');
    }
