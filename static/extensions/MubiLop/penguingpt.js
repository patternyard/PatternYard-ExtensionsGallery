    ...
    const vm = Scratch.vm;    class PenguinGPT {
        ...
        getInfo() {
            return {
                ...
                color1: '#009CCC',
                docsURI: "https://extensions.patternyard.dev/docs/PenguinAI",
                blocks: [{
